...
-(void)applicationEnterBackground{
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"status"] == true){
    ...
    for(int i=0;i<locations.count;i++){
        ...
        if(newLocation!=nil&&theAccuracy>0
           ...
           &&(!(theLocation.latitude==0.0&&theLocation.longitude==0.0))){
            ...
            [(AppDelegate *)[[UIApplication sharedApplication]delegate] setSpeed:newLocation.speed];
...
- (void)updateLocationToServer {
    ...
    [(AppDelegate*)[[UIApplication sharedApplication]delegate]locationDataWitLocation:self.myLocation];
